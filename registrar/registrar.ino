...
// const int serverPort = 2626; // Change this to your server's port
...
const char* ssid = "loy"; // Change this to your Wi-Fi network SSID
const char* password = "12345678"; // Change this to your Wi-Fi network password
const char* serverAddress = "macts-backend-registrar.onrender.com"; // Change this to your server's address
