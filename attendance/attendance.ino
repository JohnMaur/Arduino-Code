...
// const char* serverAddress = "192.168.92.90"; // Change this to your server's IP address
// const char* serverAddress = "https://macts-backend-attendance.onrender.com"; // Change this to your server's IP address
...
const char* ssid = "loy"; // Change this to your Wi-Fi network SSID
const char* password = "12345678"; // Change this to your Wi-Fi network password
const char* serverAddress = "macts-backend-attendance.onrender.com"; // Change this to your server's address
