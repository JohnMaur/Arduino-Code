...
// const char* serverAddress = "192.168.144.90"; // Change this to your server's IP address
// const int serverPort = 3232; // Change this to your server's port
...
const char* ssid = "loy"; // Change this to your Wi-Fi network SSID
const char* password = "12345678"; // Change this to your Wi-Fi network password
const char* serverAddress = "macts-backend-device-registration.onrender.com"; // Change this to your server's address
