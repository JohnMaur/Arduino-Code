...
// // const char* serverAddress = "192.168.132.90"; // Change this to your server's IP address
// const char* serverAddress = "192.168.111.90"; // Change this to your server's IP address
// // const char* ssid = "Shhh"; // Change this to your Wi-Fi network SSID
// // const char* password = "password209c"; // Change this to your Wi-Fi network password
// // const char* serverAddress = "192.168.0.2"; // Change this to your server's IP address
// const int serverPort = 2828; // Change this to your server's port
...
const char* ssid = "loy"; // Change this to your Wi-Fi network SSID
const char* password = "12345678"; // Change this to your Wi-Fi network password
const char* serverAddress = "macts-backend-rfid-registration.onrender.com"; // Change this to your server's address
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    client.setInsecure(); // Disable SSL certificate verification (use only for testing)
...
void sendTagData(WiFiClientSecure& client, String data) {
  String url = "/tagData";
  String requestBody = "tagData=" + data;
  Serial.print("Sending tag data to server: ");
  Serial.println(data);
